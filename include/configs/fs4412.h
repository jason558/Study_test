/*
 *
 * Configuation settings for the FS4412 board.
 *
...
#define CONFIG_DEVICE_STRING    "FS4412"
 ...
 */
#define CONFIG_SYS_LONGHELP                             /* undef to save memory         */
#define CONFIG_SYS_PROMPT              "FS4412 # "    /* Monitor Command Prompt       */
...
#define CONFIG_IDENT_STRING	" For Farsight FS4412 eMMC"
...
#define CONFIG_IPADDR	192.168.100.191
#define CONFIG_SERVERIP 192.168.100.192
#define CONFIG_GATEWAYIP 192.168.100.1
#define CONFIG_NETAMSK	255.255.255.0
#endif
...
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE       (0x18000000)   /* 256MB */
...
#define CONFIG_4412_BOOTLOADER "u-boot-fs4412.bin"
#define CONFIG_4412_DVT_BOOTLOADER "u-boot-fs4412.bin"
