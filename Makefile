...
CROSS_COMPILE = /usr/local/toolchain/toolchain-4.4.6/bin/arm-cortex_a8-linux-gnueabi-
endif
ifeq ($(ARCH),i386)
...
fs4412_config:  unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa9 fs4412 samsung s5pc210
...
clobber:	clean
	@find $(OBJTREE) -type f \( -name .depend \
		...
		-print0 \
		| xargs -0 rm -f
	@rm -f $(OBJS) $(obj)*.bak  $(obj)etags $(obj)TAGS \
		$(obj)*.*~
